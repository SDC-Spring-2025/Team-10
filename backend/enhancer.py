...
pytesseract.tesseract_cmd = os.path.join(os.path.join("C:", "Program Files"), os.path.join("Tesseract-OCR", "tesseract.exe"))
...
def main():
    ...
    dir_path = os.getcwd()
    config = read_config(config=os.path.join(dir_path, os.path.join("backend", "eng.yml")))
